# Loom Clone — Project Notes for Codex
...
- **LLM:** Codex Sonnet 4.6 via Vercel AI SDK (provider-agnostic; swappable to GPT-4o-mini or Gemini)
...
- [x] **M6: AI outputs + thumbnails** — webhook fans out 4 jobs (title_summary, chapters, action_items, thumbnail); Codex Sonnet 4.6 via Vercel AI SDK with Zod schemas; system ffmpeg (apk) reads from signed R2 URL; `flipToReadyIfComplete` idempotently transitions to ready.
