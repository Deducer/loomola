...
| **macOS desktop M2 — premium recorder** | Composite writer (real `AVAssetWriter`, bubble in export), recording HUD, source picker, permissions preflight, menubar quick-record + global hotkey. Spec: [`docs/superpowers/specs/2026-05-04-desktop-app-m2-premium-recorder-design.md`](docs/superpowers/specs/2026-05-04-desktop-app-m2-premium-recorder-design.md). Plan: [`docs/superpowers/plans/2026-05-04-desktop-app-m2-premium-recorder.md`](docs/superpowers/plans/2026-05-04-desktop-app-m2-premium-recorder.md). | ~1 week of focused work |
